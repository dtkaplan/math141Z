...
`r etude::include_etude("Exercises/Computing/crocodile-drive-pants.Rmd", "**Practice 1**: ", package = "USAFAexercises")`

`r etude::include_etude("Exercises/Computing/cow-talk-piano.Rmd", "**Practice 2**: ", package = "USAFAexercises")`
...
`r etude::include_etude("Exercises/Computing/rabbit-bite-scarf.Rmd", "**Practice 1**: ", package = "USAFAexercises")`

`r etude::include_etude("Exercises/Computing/deer-dive-car.Rmd", "**Practice 2**: ", package = "USAFAexercises")`
...
`r etude::include_etude("Exercises/Computing/giraffe-dream-coat.Rmd", "**Practice 1**: ", package = "USAFAexercises")`
...
There's a deeper problem. As you saw in the above, computer science makes a sensible distinction between a (computer) function itself  and the application of that function to arguments. But the mathematical notation used in algebra and calculus textbooks typically does not. For instance, you might see $y = \sin x$. Is that saying that the number $y$ is equal to the result of applying the $\sin$ function to a numerical value $x$? Is it saying that "we will name by $y$ the function $\sin$ which takes an argument named $x$.
