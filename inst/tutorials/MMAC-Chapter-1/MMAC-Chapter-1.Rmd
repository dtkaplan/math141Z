...
`r etude::include_etude("Exercises/Computing/doe-bid-vase.Rmd", "**MMAC Question 1.2.6*: ", package = "USAFAexercises")`
...
`r etude::include_etude("Exercises/Computing/camel-lie-gloves.Rmd", "**MMAC Question 1.3.9**: ", package = "USAFAexercises")`
...
`r etude::include_etude("Exercises/Computing/octopus-know-bottle.Rmd", "**Practice 1**: ", package = "USAFAexercises")`
